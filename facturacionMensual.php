...
<?php
    ...
    while ($final_resultado_facturacion_mensual = mysqli_fetch_assoc($sql_resultado_facturacion_mensual)){
        echo "<tr>
            ...
            <td><a href='facturaFacturacionMensual.php?id=" . $ran .
            "&cabinaNombre=" . $final_resultado_facturacion_mensual['cabinaNombre'] .
            "&total=" . $final_resultado_facturacion_mensual['total'] .
            "&porcentaje=" .round(($final_resultado_facturacion_mensual['total']*100)/$total_mes,2)." %
            '>Factura</a></td> 
      </tr>";
    }
?>
