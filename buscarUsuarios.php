...
<center>
    <h3 class="w3-xxxlarge w3-center w3-lobster">Buscar usuario por email</h3>
...
if (isset($_POST['busca'])) {
    $busca = $_POST['busca']; /*Aca agarro lo del input*/
        if ($busca == ""){ /*SI $busca esta vacio que me tire este error. Sino que haga la query*/
            ...
            $busqueda = "SELECT id,nombre, apellido,email FROM usuarios WHERE email  LIKE '$busca'";
...
<center>
    <div class="w3-display-container">
        ...
        <td><a href='reservasPorClientes.php?id=" . $final_busqueda[$i][0] ."'>Ver reservas</a></td> <!-- ID -->
