    ...
    while ($fila_cabina_mas_vendida = mysqli_fetch_assoc($sql_resultado_cabina_mas_vendida)){
        echo "<tr>
            ...
            <td>".round(($fila_cabina_mas_vendida['cantidad']*100)/$total_mes,2)." %</td>
             <td><a href='facturaCabinaMasReservada.php?id=" . $ran .
            "&cabinaNombre=" . $fila_cabina_mas_vendida['cabinaNombre'] .
            "&cantidad=" . $fila_cabina_mas_vendida['cantidad'] .
            "&porcentaje=" . round(($fila_cabina_mas_vendida['cantidad']*100)/$total_mes,2)."%'>Factura</a></td> 
      </tr>";
    }
?>
    </table>
